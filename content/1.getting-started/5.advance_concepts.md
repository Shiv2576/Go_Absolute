...
This keeps Latency Low  and System Responsive.
...
This is a Simple Http Server using all the concepts listed above:


- Rate Limiter -> protects policy.
- Semaphore -> controls concurrency.
- Context -> protects lifecycle
- Reject-Fast -> protects latency.
- Shutdown -> protects correctness.
...
Run this code , and then in second instance of terminal use :
